...
INSERT INTO apparel_variation (apparel_id NOT NULL, inventory_id INT color VARCHAR(30), size VARCHAR(10), gender VARCHAR (10), cost DECIMAL(5,2), sales_price DECIMAL(5,2))
VALUES
    (),
    ();
